...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FeatureIpmi) DeepCopyInto(out *FeatureIpmi) {
	*out = *in
	if in.Port != nil {
		in, out := &in.Port, &out.Port
		if *in == nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FeatureIpmi.
func (in *FeatureIpmi) DeepCopy() *FeatureIpmi {
	if in == nil {
		return nil
	}
	out := new(FeatureIpmi)
